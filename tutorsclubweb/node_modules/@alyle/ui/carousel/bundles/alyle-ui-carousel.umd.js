(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@alyle/ui'), require('@angular/common'), require('@angular/platform-browser'), require('@alyle/ui/ripple')) :
	typeof define === 'function' && define.amd ? define('ly.carousel', ['exports', '@angular/core', '@alyle/ui', '@angular/common', '@angular/platform-browser', '@alyle/ui/ripple'], factory) :
	(factory((global.ly = global.ly || {}, global.ly.carousel = {}),global.ng.core,global.ly.core,global.ng.common,global.ng.platformBrowser,global.ly.ripple));
}(this, (function (exports,core,ui,common,platformBrowser,ripple) { 'use strict';
...
CarouselService.ngInjectableDef = core.defineInjectable({ factory: function CarouselService_Factory() { return new CarouselService(core.inject(ui.LyTheme)); }, token: CarouselService, providedIn: ui.AlyleUIModule });
...
LyCarousel.propDecorators = {
    "lyItems": [{ type: core.ContentChildren, args: [core.forwardRef(function () { return LyCarouselItemComponent; }),] },],
...
LyCarouselItemComponent.ctorParameters = function () { return [
    { type: LyCarousel, decorators: [{ type: core.Optional },] },
...
LyCarouselItemComponent.propDecorators = {
    "src": [{ type: core.Input },],
    "lyCarouselActive": [{ type: core.Input }, { type: core.HostBinding, args: ['class.ly-carousel-item-active',] },],
};
...
exports.LyCarouselItemComponent = LyCarouselItemComponent;
