(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('ly.ripple', ['exports', '@alyle/ui', '@angular/core', '@angular/common'], factory) :
	(factory((global.ly = global.ly || {}, global.ly.ripple = {}),global.ly.core,global.ng.core,global.ng.common));
}(this, (function (exports,ui,core,common) { 'use strict';
...
LyRippleService.ngInjectableDef = core.defineInjectable({ factory: function LyRippleService_Factory() { return new LyRippleService(core.inject(ui.LyTheme)); }, token: LyRippleService, providedIn: ui.AlyleUIModule });
var LyRipple = /** @class */ (function () {
    ...
    Object.defineProperty(LyRipple.prototype, "lyRippleConfig", {
        get: function () {
            return {
                centered: ui.toBoolean(this.lyRippleCentered),
                disabled: ui.toBoolean(this.lyRippleDisabled),
                sensitive: ui.toBoolean(this.lyRippleSensitive),
...
LyRipple.propDecorators = {
    "lyRippleCentered": [{ type: core.Input },],
    "lyRippleDisabled": [{ type: core.Input },],
    "lyRippleSensitive": [{ type: core.Input },],
    "lyRippleRadius": [{ type: core.Input },],
    "lyRipplePercentageToIncrease": [{ type: core.Input },],
};
...
//# sourceMappingURL=alyle-ui-ripple.umd.js.map
