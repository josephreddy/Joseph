(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('chroma-js'), require('rxjs'), require('rxjs/operators')) :
	typeof define === 'function' && define.amd ? define('ly.core', ['exports', '@angular/core', '@angular/common', 'chroma-js', 'rxjs', 'rxjs/operators'], factory) :
	(factory((global.ly = global.ly || {}, global.ly.core = {}),global.ng.core,global.ng.common,global.chroma,global.rxjs,global.rxjs.operators));
}(this, (function (exports,core,common,_chroma,rxjs,operators) { 'use strict';
...
LyRootService.ngInjectableDef = core.defineInjectable({ factory: function LyRootService_Factory() { return new LyRootService(core.inject(common.DOCUMENT), core.inject(core.RendererFactory2)); }, token: LyRootService, providedIn: "root" });
var classId = 0;
var prefix;
...
LyTheme.ctorParameters = function () { return [
    { type: ThemeVariables, decorators: [{ type: core.Inject, args: [THEME_VARIABLES,] },] },
    { type: undefined, decorators: [{ type: core.Inject, args: [IS_CORE_THEME,] },] },
    { type: undefined, decorators: [{ type: core.Inject, args: [common.DOCUMENT,] },] },
    { type: LyRootService, },
]; };
function mergeDeep() {
...
var LY_GLOBAL_CONTRAST = new core.InjectionToken('ly.global.contrast');
var NgTranscludeDirective = /** @class */ (function () {
    function NgTranscludeDirective(_viewRef) {
        this._viewRef = _viewRef;
        this.ngTranscludeChange = new core.EventEmitter();
...
NgTranscludeDirective.propDecorators = {
    ...
    "ngTranscludeChange": [{ type: core.Output },],
};
...
LyShadowService.decorators = [
    { type: core.Injectable, args: [ProvidedInTheme,] },
];
LyShadowService.ctorParameters = function () { return [
    { type: LyTheme, },
]; };
LyShadowService.ngInjectableDef = core.defineInjectable({ factory: function LyShadowService_Factory() { return new LyShadowService(core.inject(LyTheme)); }, token: LyShadowService, providedIn: AlyleUIModule });
...
LyBgColorAndRaised.ctorParameters = function () { return [
    ...
    { type: undefined, decorators: [{ type: core.Inject, args: [LY_GLOBAL_CONTRAST,] }, { type: core.Optional },] },
]; };
...
LyNewRaised.decorators = [
    { type: core.Directive, args: [{ selector: ':not([raised])[newRaised]' },] },
];
...
var LY_OVERLAY_CONTAINER_PROVIDER = {
    ...
    deps: [[new core.Optional(), new core.SkipSelf(), LyOverlayContainer]],
...
var LyFocusState = /** @class */ (function () {
    function LyFocusState(elementRef, _ngZone, _renderer, _cd) {
        ...
        this.lyFocusChange = new core.EventEmitter();
...
LyFocusState.propDecorators = {
    "lyFocusChange": [{ type: core.Output },],
};
...
LyThemeStyles.decorators = [
    { type: core.Injectable, args: [{ providedIn: AlyleUIModule },] },
];
LyThemeStyles.ctorParameters = function () { return [
    { type: LyTheme, },
]; };
LyThemeStyles.ngInjectableDef = core.defineInjectable({ factory: function LyThemeStyles_Factory() { return new LyThemeStyles(core.inject(LyTheme)); }, token: LyThemeStyles, providedIn: AlyleUIModule });
...
LyGlobalStyles.ngInjectableDef = core.defineInjectable({ factory: function LyGlobalStyles_Factory() { return new LyGlobalStyles(core.inject(LyTheme)); }, token: LyGlobalStyles, providedIn: "root" });

exports.getContrastYIQ = getContrastYIQ;
exports.LyTheme = LyTheme;
...
exports.toRgb = toRgb;
exports.converterToHex = converterToHex;
exports.rgbToHex = rgbToHex;
exports.rgbTransparent = rgbTransparent;
...
exports.AlyleUIModule = AlyleUIModule;
exports.ProvidedInTheme = ProvidedInTheme;
...
exports.LyThemeStyles = LyThemeStyles;
exports.LyGlobalStyles = LyGlobalStyles;
