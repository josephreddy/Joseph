...
import { isEmpty, sortBy } from 'lodash/index';
...
class IntPhonePrefixComponent {
     ...
     */
    constructor(service, localeService, phoneComponent) {
     ...
     * @return {?}
     */
    updatePhoneInput(countryCode) {
        this.showDropdown = false;
        let /** @type {?} */ newInputValue = IntPhonePrefixComponent.startsWithPlus(this.phoneInput)
     ...
     */
    findPrefix(prefix) {
        let /** @type {?} */ foundPrefixes = this.countries.filter((country) => prefix.startsWith(country.dialCode));
...
class CountryPipe {
    ...
    transform(value, args) {
        ...
        if (value) {
            return value.filter((country) => country.name.search(searchText) !== -1);
        }
    }
}
...
class InternationalPhoneModule {
}
...
//# sourceMappingURL=ng4-intl-phone.js.map
