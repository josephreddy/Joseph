...
export declare class NgbInputDatepicker implements OnChanges, OnDestroy, ControlValueAccessor, Validator {
     ...
     * @since 1.1.1
     */
    dateSelect: EventEmitter<NgbDateStruct>;
    /**
    ...
    constructor(_parserFormatter: NgbDateParserFormatter, _elRef: ElementRef<HTMLInputElement>, _vcRef: ViewContainerRef, _renderer: Renderer2, _cfr: ComponentFactoryResolver, ngZone: NgZone, _service: NgbDatepickerService, _calendar: NgbCalendar, _ngbDateAdapter: NgbDateAdapter<any>, _document: any);
