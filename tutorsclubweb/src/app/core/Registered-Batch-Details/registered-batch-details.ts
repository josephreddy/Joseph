...
@Component({
  selector: 'app-registered-batch-details',
  templateUrl: './registered-batch-details.html',
  styleUrls: ['./registered-batch-details.css']
})
export class RegisteredBatchDetails implements OnInit {
